        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <input
                ...
                className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 sm:text-sm text-gray-900 placeholder-gray-500 px-3 py-2 ${
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 sm:text-sm text-gray-900 px-3 py-2 ${
            ...
            <div>
              ...
              <select
                ...
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 sm:text-sm disabled:bg-gray-100 disabled:cursor-not-allowed text-gray-900 disabled:text-gray-500 px-3 py-2"
              >
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              min="0"
              className={`mt-1 block w-full sm:w-32 rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 sm:text-sm text-gray-900 px-3 py-2 ${
